...
const AGENT_EVENT: &str = "cli-ck:agent-signal";
...
const OVERFLOW_NOTICE: &[u8] =
    b"\x1bc\x1b[2m[cli-ck: dropped output due to backpressure]\x1b[0m\r\n";
