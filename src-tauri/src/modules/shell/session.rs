...
fn generate_sentinel() -> String {
    ...
    format!("__OZ_CWD_{:016x}_{:016x}__", mix, counter)
}
...
mod tests {
    ...
    fn sentinels_are_unique_per_session() {
        ...
        assert!(a.sentinel.starts_with("__OZ_CWD_"));
    ...
    fn strip_uses_session_sentinel_only() {
        ...
        let attacker = "__OZ_CWD_0000000000000000_0000000000000000__/evil";
        let trailer = format!("\n{}/real\n", s.sentinel);
