...
cli-ck is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about cli-ck. Take off-topic conversations elsewhere.
...
If you see a violation — or experience one — email **contact@codecollab.co** with subject `[cli-ck conduct]`. Include links and context.
