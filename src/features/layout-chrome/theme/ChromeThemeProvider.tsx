...
export function ChromeThemeProvider({ children, defaultMode = "system" }: ThemeProviderProps) {
...
export function useTheme(): ThemeProviderState {
  ...
  if (!ctx) throw new Error("useTheme must be used within a <ChromeThemeProvider>");
  return ctx;
}
