...
import type { UpdateChannel } from "@/features/layout-chrome/updater";
...
const STORE_PATH = "cli-ck-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "cli-ck://prefs-changed";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  return {
    ...
    sttProvider: migrateLegacySttProvider(get<SttProvider>(KEY_STT_PROVIDER)),
    groqSttModel:
    ...
    updateChannel:
      get<UpdateChannel>(KEY_UPDATE_CHANNEL) === "beta"
        ? "beta"
...
const KEYS_CHANGED_EVENT = "cli-ck://ai-keys-changed";
