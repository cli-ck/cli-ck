...
Direction and scope decisions are made by the core maintainers. Trusted reviewers (informal, no fixed roles yet) provide input on security, performance, and platform-specific areas.

If a PR is closed and you disagree, raise it on GitHub Discussions.
